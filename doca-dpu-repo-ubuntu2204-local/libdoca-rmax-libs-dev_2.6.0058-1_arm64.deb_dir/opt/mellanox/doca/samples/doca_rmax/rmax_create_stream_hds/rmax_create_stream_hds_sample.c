...
/*
 * Run create_stream_hds sample, which creates stream in header-split mode
 *
 ...
 */
doca_error_t
rmax_create_stream_hds(struct rmax_program_state *state, struct rmax_stream_config *stream_config)
{
