...
void match_set_tun_gtpu_msgtype_masked(struct match *match, uint8_t msgtype,
                                       uint8_t mask);
void match_set_tun_eth_src(struct match *match, const struct eth_addr dl_src);
void match_set_tun_eth_src_masked(struct match *, const struct eth_addr dl_src,
                                  const struct eth_addr mask);
void match_set_tun_eth_dst(struct match *match, const struct eth_addr dl_dst);
void match_set_tun_eth_dst_masked(struct match *, const struct eth_addr dl_dst,
                                  const struct eth_addr mask);
void match_set_tun_type(struct match *, uint8_t type);
void match_set_tun_type_masked(struct match *, uint8_t type, uint8_t mask);
