...
enum ovs_tunnel_key_attr {
	...
	OVS_TUNNEL_KEY_ATTR_ETH_SRC,		/* eth src. */
	OVS_TUNNEL_KEY_ATTR_ETH_DST,		/* eth dst. */
	OVS_TUNNEL_KEY_ATTR_EXPLICIT,		/* No argument. tunnel explicit. */
	OVS_TUNNEL_KEY_ATTR_TYPE,			/* Tunnel type. */
#endif
...
enum ovs_action_attr {
	...
	OVS_ACTION_ATTR_TUN_DECAP,     /* u32 port number. */
