...
static sflow_upcall_callback ofproto_dpif_sflow_upcall_cb;
...
udpif_create(struct dpif_backer *backer, struct dpif *dpif)
{
    ...
    dpif_register_sflow_upcall_cb(dpif, ofproto_dpif_sflow_upcall_cb);
...
int
ofproto_dpif_sflow_upcall_cb(struct dpif_upcall_sflow *dupcall)
{
