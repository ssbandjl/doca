...
/* ## -------- ## */
    ...
    /* "tun_eth_src" (aka "tun_dl_src").
     *
     * Tunnel source address in Ethernet header.
     *
     * Type: MAC.
     * Maskable: bitwise.
     * Formatting: Ethernet.
     * Prerequisites: none.
     * Access: read/write.
     * NXM: NXM_OF_TUN_ETH_SRC(115) since v1.0.
     * OXM: none.
     */
    MFF_TUN_ETH_SRC,

    /* "tun_eth_dst" (aka "tun_dl_dst").
     *
     * Tunnel destination address in Ethernet header.
     *
     * Type: MAC.
     * Maskable: bitwise.
     * Formatting: Ethernet.
     * Prerequisites: none.
     * Access: read/write.
     * NXM: NXM_OF_TUN_ETH_DST(116) since v1.0.
     * OXM: none.
     */
    MFF_TUN_ETH_DST,
     ...
     * Prerequisites: none.
     * Access: read-only.
     * NXM: NXM_OF_TUN_TYPE(117) since v1.0.
     * OXM: none.
     */
    MFF_TUN_TYPE,
