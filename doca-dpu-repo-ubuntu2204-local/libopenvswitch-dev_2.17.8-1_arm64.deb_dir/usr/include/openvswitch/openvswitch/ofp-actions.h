...
#define OFPACTS                                                         \
    ...
    OFPACT(TUN_ENCAP,       ofpact_tun_cap,     ofpact, "tun_encap")    \
    OFPACT(TUN_DECAP,       ofpact_tun_cap,     ofpact, "tun_decap")    \
                                                                        \
    /* Metadata. */                                                     \
...
/* OFPACT_TUN_ENCAP.
 *
 * Used for NXAST_TUN_ENCAP, NXAST_TUN_DECAP. */
struct ofpact_tun_cap {
    OFPACT_PADDED_MEMBERS(
        struct ofpact ofpact;
        ofp_port_t tnl_port;        /* Tunnel port. */
    );
};
