...
/* Define to 1 if you have the declaration of `UCP_MEM_MAP_SYMMETRIC_RKEY',
   and to 0 if you don't. */
#define HAVE_DECL_UCP_MEM_MAP_SYMMETRIC_RKEY 1
...
/* Define to 1 if you have the declaration of `ucp_rkey_compare', and to 0 if
   you don't. */
#define HAVE_DECL_UCP_RKEY_COMPARE 1
...
/* Define to 1 if you have the declaration of `UCS_MEMORY_TYPE_RDMA', and to 0
   if you don't. */
#define HAVE_DECL_UCS_MEMORY_TYPE_RDMA 1
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-DNDEBUG -O3 -g -finline-functions -fno-strict-aliasing  -D__EXTENSIONS__' CPPFLAGS='-I/var/tmp/openmpi/openmpi-4.1.7a1/opal/mca/event/libevent2022/libevent -I/var/tmp/openmpi/openmpi-4.1.7a1/opal/mca/event/libevent2022/libevent/include -I/var/tmp/openmpi/openmpi-4.1.7a1/opal/mca/hwloc/hwloc201/hwloc/include -Wdate-time -D_FORTIFY_SOURCE=2  -I/usr/local/include -I/usr/local/include' FFLAGS='-g -ffile-prefix-map=/var/tmp/openmpi/openmpi-4.1.7a1=. -flto=auto -ffat-lto-objects -flto=auto -ffat-lto-objects -fstack-protector-strong -O3' LDFLAGS='-Wl,-Bsymbolic-functions -flto=auto -ffat-lto-objects -flto=auto -Wl,-z,relro ' --enable-shared --disable-static  --prefix=/usr/mpi/gcc/openmpi-4.1.7a1 --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_TARBALL_VERSION "4.1.7a1"
...
#define OPAL_IDENT_STRING "4.1.7a1"
...
#define OPAL_PACKAGE_STRING "Open MPI root@bf2d482dda56 Distribution"
...
#define OPAL_RELEASE_DATE "Jan 31, 2024"
...
#define OPAL_TARBALL_VERSION "4.1.7a1"
...
#define ORTE_RELEASE_DATE "Jan 31, 2024"
...
#define ORTE_REPO_REV "v4.1.5-106-gefbeca7"

/* Tarball filename version string of Open MPI Run-Time Environment */
#define ORTE_TARBALL_VERSION "4.1.7a1"
...
#define OSHMEM_TARBALL_VERSION "4.1.7a1"
...
#define PACKAGE_STRING "Open MPI 4.1.7a1"
...
#define PACKAGE_VERSION "4.1.7a1"
...
#define WRAPPER_EXTRA_LIBS "-lm -ludev  -lz"
