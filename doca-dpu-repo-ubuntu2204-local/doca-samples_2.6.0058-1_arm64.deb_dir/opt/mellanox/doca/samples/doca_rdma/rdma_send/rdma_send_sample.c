 ...
 */
static void
rdma_send_completed_callback(struct doca_rdma_task_send *rdma_send_task,
 ...
 */
static void
rdma_send_error_callback(struct doca_rdma_task_send *rdma_send_task,
			 union doca_data task_user_data, union doca_data ctx_user_data)
{
	struct rdma_resources *resources = (struct rdma_resources *)ctx_user_data.ptr;
 ...
 */
static doca_error_t
rdma_send_export_and_connect(struct rdma_resources *resources)
{
	doca_error_t result;
 ...
 */
static doca_error_t
rdma_send_prepare_and_submit_task(struct rdma_resources *resources)
{
	...
	result = doca_rdma_task_send_allocate_init(resources->rdma, resources->src_buf, task_user_data,
								&rdma_send_task);
	if (result != DOCA_SUCCESS) {
 ...
 */
static void
rdma_send_state_change_callback(const union doca_data user_data, struct doca_ctx *ctx,
