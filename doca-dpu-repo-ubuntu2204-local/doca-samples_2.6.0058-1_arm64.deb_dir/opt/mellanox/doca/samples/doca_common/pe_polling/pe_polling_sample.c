 ...
 */
doca_error_t
create_dma(struct pe_polling_sample_state *state)
{
 ...
 */
void
cleanup(struct pe_polling_sample_state *state)
{
 ...
 */
doca_error_t
run(struct pe_polling_sample_state *state)
{
