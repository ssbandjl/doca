...
PACKAGE_VERSION=${PACKAGE_VERSION:-"24.01.OFED.24.01.0.3.3.1"}
...
EXTRA_OPTIONS="--with-mlx5-ipsec --with-gds --without-gds --without-odp --without-xdp --with-sf-cfg-drv --with-sf-sfc"
configure_options="--with-mlx5-ipsec --with-gds --with-sf-cfg-drv --with-sf-sfc --without-xdp --without-odp"
